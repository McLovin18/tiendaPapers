...
const ProductsMaquillajePage = () => {
  const { user } = useAuth();
  const [searchTerm, setSearchTerm] = useState("");
  const router = useRouter();

  // Usar el hook personalizado para cargar productos de la categoría maquillaje
  const { products, loading } = useProducts("/maquillaje");
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 w-100">
          <Container className="py-5 py-lg-5 py-md-2 py-sm-2">
            <h1 className="fw-bold text-center mb-5">💄 Maquillaje</h1>
            <p className="text-center text-muted mb-4">
              Descubre nuestra colección de maquillaje profesional. Desde bases perfectas hasta labiales de larga duración.
            </p>
            ...
            <Row className="g-4">
              {loading ? (
                <Col xs={12} className="text-center py-5">
                  ...
                  <p className="text-muted">Obteniendo productos de maquillaje</p>
                </Col>
                ...
                <Col xs={12} className="text-center py-5">
                  ...
                  <h4 className="mt-3 text-muted">
                    No se encontraron productos de maquillaje
                  </h4>
...
export default ProductsMaquillajePage;
