...
const ProductsCuidadoPielPage = () => {
  ...
  // Usar el hook personalizado para cargar productos de la categoría cuidado-piel
  const { products, loading } = useProducts("/cuidado-piel");
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 w-100">
          <Container className="py-5 py-lg-5 py-md-2 py-sm-2">
            <h1 className="fw-bold text-center mb-5">🧴 Cuidado de la Piel</h1>
            <p className="text-center text-muted mb-4">
              Transforma tu rutina de cuidado con nuestros productos especializados. Sérums, cremas y tratamientos para todo tipo de piel.
            </p>
            ...
            <div className="d-flex justify-content-center mb-4">
              <form className="w-100" style={{ maxWidth: 500 }}>
                <div className="input-group">
                  <input
                    type="text"
                    placeholder="Buscar productos para el cuidado de la piel..."
                    value={searchTerm}
            ...
            <Row className="g-4">
              {loading ? (
                <Col xs={12} className="text-center py-5">
                  ...
                  <p className="text-muted">Obteniendo productos de cuidado de la piel</p>
                </Col>
                ...
                <Col xs={12} className="text-center py-5">
                  ...
                  <h4 className="mt-3 text-muted">
                    No se encontraron productos de cuidado de la piel
                  </h4>
...
export default ProductsCuidadoPielPage;
