...
// Importar los productos desde la página principal de productos
import allProducts from "../productsData";

const ProductsHombrePage = () => {
  const { user } = useAuth();
  const [searchTerm, setSearchTerm] = useState("");
  // Filtrar productos para la categoría hombre
  const products = allProducts.filter((product) => product.categoryLink === "/hombre");
